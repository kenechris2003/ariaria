    ...
    <div className="bg-white w-full h-full flex justify-between">
      ...
      <div className="shadow-[0_10px_15px_-2px_rgba(0,0,0,0.1),0_-10px_15px_-2px_rgba(0,0,0,0.1),10px_0_15px_-2px_rgba(0,0,0,0.1),-10px_0_15px_-2px_rgba(0,0,0,0.1)] rounded-[30px] w-full h-fit max-w-md p-3 lg:p-5 mx-5 lg:mx-auto mt-10 bg-white flex flex-col text-black">
        ...
        <div className="text-center flex flex-col gap-3 py-10">
          <h1 className={`font-bold text-3xl mt-4 ${CustomFont.className}`}>
            Sign Up
          </h1>
        ...
        <form className="flex flex-col gap-32">
          <div className="flex flex-col gap-5">
            ...
            <span className="flex items-center gap-2">
              <input
                className="flex h-10 rounded-md border border-input bg-transparent px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-4"
                type="checkbox"
                onClick={() => setCheckBox(!checkBox)}
              />
              <p className="text-[14px] text-left">
                By registering, you agree to our
                <a className="text-orange-500" href="/Termofuse">
                  {" "}
                  Terms of Use{" "}
                </a>
                and
                <a className="text-orange-500" href="/Policy">
                  {" "}
                  Privacy and Policy{" "}
                </a>
              </p>
          ...
          <div className="flex flex-col gap-5">
            <button
              className="inline-flex items-center justify-center rounded-md text-sm font-medium text-white disabled:bg-orange-300 bg-orange-500 h-10 px-4 py-2"
              type="submit"
              disabled={!checkBox || !isPhoneValid} 
            >
              Sign Up
            </button>
          </div>
